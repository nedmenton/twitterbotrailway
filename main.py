...
class CryptoIntelligencePlatform:
    ...
    def score_account(self, account_data: Dict, discovered_by: str) -> Dict:
        ...
        power_users_following, power_user_score = self.check_power_user_followers(handle)

        if discovered_by not in power_users_following:
            power_users_following.append(discovered_by)
